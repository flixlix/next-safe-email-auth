...
import { type User } from "@/features/auth/lib/server/user"
import { decodeBase64, encodeBase64 } from "@oslojs/encoding"
import { useActionState, useState } from "react"
import { registerSecurityKeyAction } from "../actions/register-key"

const initialRegisterSecurityKeyState = {
  message: "",
}

export default function RegisterSecurityKey(props: {
